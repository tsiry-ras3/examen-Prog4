package hei.school.examen.handler;

import static hei.school.examen.concurrency.ThreadRenamer.renameWorkerThread;
...
import hei.school.examen.PojaApplication;
import hei.school.examen.PojaGenerated;
import hei.school.examen.endpoint.EndpointConf;
import hei.school.examen.endpoint.event.EventConf;
import hei.school.examen.endpoint.event.consumer.EventConsumer;
import hei.school.examen.endpoint.event.consumer.model.ConsumableEvent;
import hei.school.examen.endpoint.event.consumer.model.ConsumableEventTyper;
