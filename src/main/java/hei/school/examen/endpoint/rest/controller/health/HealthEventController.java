package hei.school.examen.endpoint.rest.controller.health;

import static hei.school.examen.endpoint.rest.controller.health.PingController.KO;
import static hei.school.examen.endpoint.rest.controller.health.PingController.OK;
import static java.util.UUID.randomUUID;

import hei.school.examen.PojaGenerated;
import hei.school.examen.endpoint.event.EventProducer;
import hei.school.examen.endpoint.event.model.DurablyFallibleUuidCreated1;
import hei.school.examen.endpoint.event.model.UuidCreated;
import hei.school.examen.repository.DummyUuidRepository;
